...
export const CreateClientSchema = z.object({
  clientCode: z.string().min(2).max(20).regex(/^[A-Z0-9_-]+$/, 'Client code must be uppercase alphanumeric, hyphens or underscores'),
  ...
  environment: z.enum(['Production', 'UAT', 'Test', 'Development']),
